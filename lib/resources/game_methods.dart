...
import 'package:multiplayer_tictactoe/utils/utils.dart';
import 'package:provider/provider.dart';
import 'package:socket_io_client/socket_io_client.dart';

class GameMethods {
  void checkWninner(BuildContext context, Socket SocketClient) {
    ...
    if(roomDataProvider.displayElements[0] ==
        ...
        roomDataProvider.displayElements[0] ==context
    ...
    if(winner != '') {
      if(roomDataProvider.player1.playerType == winner) {
        showGameDialog(context, '4{roomDataProvider.player1.nickname} won!');
  ...
  void clearBoard(BuildContext context) {
    ...
    for(int i= 0; i < roomDataProvider.displayElements.length; i++) {
      roomDataProvider.updatePlayersStateListener(i, '');
    }
